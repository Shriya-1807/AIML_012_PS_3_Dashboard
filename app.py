...
st.markdown("""
    <style>
        ...
        .title {font-size: 20px; font-family: Georgia, serif; text-align: center; margin-top: 0px !important; padding-top: 0px !important;}
...
#Video
st.markdown(
    '<p style="font-size:22px; font-family:\'Segoe UI\', sans-serif; font-weight:bold; color:#8cc8e6; margin-top:30px;">🎥 Upload a drone video</p>',
    unsafe_allow_html=True
)
